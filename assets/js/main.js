...
(function () {
  ...
  var I18N = {
    es: {
      ...
      'cta.mosaicoAlt': 'Nuestra cultura en imágenes',
      ...
      'galeria.alt10': 'Mochilas wayuu en el mercado',
      ...
      'galeria.alt6': 'Vallenato en vivo junto al mar',
      'galeria.alt7': 'Sombreros vueltiaos y artesanías',
      'galeria.alt8': 'Centro histórico de Bogotá',
      'galeria.alt9': 'Palenquera de Cartagena',
      'galeria.cap1': 'Santuario de Las Lajas, Nariño',
      'galeria.cap10': 'Mochilas wayuu en el mercado',
      ...
      'galeria.cap6': 'Vallenato en vivo junto al mar',
      'galeria.cap7': 'Sombreros vueltiaos y artesanías',
      'galeria.cap8': 'Centro histórico de Bogotá',
      'galeria.cap9': 'Palenquera de Cartagena',
      ...
      'qs.mosaico': 'La Colombia que llevamos a Dallas.',
      'qs.mosaicoEyebrow': 'Nuestra cultura en imágenes',
      'qs.mosaicoP': 'Cada foto es un pedazo de casa. Las ponemos aquí para que quienes crecen lejos sepan de dónde vienen, y para que quienes acaban de llegar se reconozcan.',
      'qs.mt1': 'Arquitectura',
      'qs.mt2': 'Café',
      'qs.mt3': 'Sombreros vueltiaos',
      'qs.mt4': 'Artesanía',
      'qs.mt5': 'Baile',
    ...
    en: {
      ...
      'ct.title': 'Let’s talk',
      'cta.eyebrow': 'Join us',
      'cta.mosaicoAlt': 'Our culture in pictures',
      ...
      'galeria.alt10': 'Wayuu bags at the market',
      'galeria.alt2': 'Bogotá at sunset',
      'galeria.alt3': 'Clock Tower, Cartagena',
      'galeria.alt4': 'Cristo Rey, Cali',
      'galeria.alt5': 'Monserrate, Bogotá',
      'galeria.alt6': 'Live vallenato by the sea',
      'galeria.alt7': 'Sombreros vueltiaos and crafts',
      'galeria.alt8': 'Historic centre of Bogotá',
      'galeria.alt9': 'Palenquera of Cartagena',
      'galeria.cap1': 'Las Lajas Sanctuary, Nariño',
      'galeria.cap10': 'Wayuu bags at the market',
      'galeria.cap2': 'Bogotá at sunset',
      'galeria.cap3': 'Clock Tower, Cartagena',
      'galeria.cap4': 'Cristo Rey, Cali',
      'galeria.cap5': 'Monserrate, Bogotá',
      'galeria.cap6': 'Live vallenato by the sea',
      'galeria.cap7': 'Sombreros vueltiaos and crafts',
      'galeria.cap8': 'Historic centre of Bogotá',
      'galeria.cap9': 'Palenquera of Cartagena',
      ...
      'qs.mosaico': 'The Colombia we bring to Dallas.',
      'qs.mosaicoEyebrow': 'Our culture in pictures',
      'qs.mosaicoP': 'Every picture is a piece of home. We put them here so those growing up far away know where they come from, and so those who have just arrived recognise themselves.',
      'qs.mt1': 'Architecture',
      'qs.mt2': 'Coffee',
      'qs.mt3': 'Sombreros vueltiaos',
      'qs.mt4': 'Crafts',
